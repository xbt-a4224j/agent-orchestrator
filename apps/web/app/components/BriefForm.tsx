...
export default function BriefForm({ onSubmit }: BriefFormProps) {
  const [brief, setBrief] = useState<Brief>(SAMPLE_BRIEFS["notion"]!.brief);
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm">Typed multi-agent B2B outreach — planner → specialists → coordinated packet</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <fieldset className="border border-gray-800 rounded-lg p-4 space-y-3">
          <legend className="text-xs text-gray-500 px-1 uppercase tracking-wider">Options</legend>
          <Field label="Goal">
            <select
              className="input"
              value={brief.goal ?? "book_meeting"}
          ...
          <Field label="Constraints">
            <input
              ...
              placeholder="Keep tone peer-to-peer. No hyperbole."
            />
          </Field>
        </fieldset>
