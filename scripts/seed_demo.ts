...
const BRIEFS = [
  ...
  },
  {
    ...
    offer: { product: "Quotient", value_prop: "Cut campaign launch time from weeks to hours with AI-driven multi-channel execution" },
    sender: { name: "Alex", company: "Quotient", role: "AE" },
    goal: "book_meeting" as const,
  },
  {
    ...
    offer: { product: "Quotient", value_prop: "One AI agent that writes, schedules, and executes your entire ABM campaign across email, LinkedIn, and content" },
    sender: { name: "Alex", company: "Quotient", role: "AE" },
    goal: "book_meeting" as const,
  },
];
